...
import officeImg from '../assets/office.jpg'; // Update path if needed
  ...
  <AnimatedSection id="contact" className={styles.contactSection}>
    ...
    <div className={styles.contactMainWrapper}>
      <div className={styles.officeImageWrapper}>
        <img src={officeImg} alt="Haven Hub Infra Office Interior" className={styles.officeImage} />
        <div className={styles.officeImageCaption}>Haven Hub Infra Office Interior</div>
      </div>
      <div className={styles.contactDetailsCard}>
        <h3 className={styles.contactGetInTouch}>Get in touch</h3>
        <div className={styles.contactInfoBlock}>
          <div className={styles.contactLabel}><strong>ADDRESS</strong></div>
          <div className={styles.contactValue}>D-99, Ground Floor, Sec - 2, Noida, UP, 201301</div>
        </div>
        <div className={styles.contactInfoBlock}>
          <div className={styles.contactLabel}><strong>EMAIL</strong></div>
          <div className={styles.contactValue}><a href="mailto:contact@havenhubinfra.com">contact@havenhubinfra.com</a></div>
        </div>
        <div className={styles.contactInfoBlock}>
          <div className={styles.contactLabel}><strong>PHONE</strong></div>
          <div className={styles.contactValue}><a href="tel:+918882131199">+91 8882131199</a></div>
        </div>
        <button className={styles.scheduleCallBtn}>SCHEDULE A CALL</button>
      </div>
    </div>
    <div className={styles.contactSocial}>
      <h4>Connect with us:</h4>
      <div className={styles.socialLinks}>
        {contactData.social.map((s, i) => (
          <a
            key={s.label}
            href={s.href}
            target="_blank"
            ...
            aria-label={s.label}
            className={styles.socialIcon + ' animated'}
